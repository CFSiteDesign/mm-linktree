      ...
      <div className="w-full max-w-md px-6 flex flex-col gap-8 mt-20 z-10">
        ...
        <section className="bg-white border-4 border-black p-8 shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] flex flex-col items-center text-center relative">
          ...
          <div className="w-32 h-32 rounded-full border-4 border-black mb-6 transform hover:scale-105 transition-transform shadow-lg overflow-hidden flex items-center justify-center bg-white">
             <img
               src={property.logoUrl ?? madMonkeyLogo}
          ...
          <h1 className="font-bold text-lg text-neutral-900 mb-1 tracking-tight w-full text-center">
            {property.displayHandle ?? `@madmonkey${cleanHandle}`}
          </h1>
          ...
          {(property.instagramUrl || property.tiktokUrl) && (
          <div className="flex justify-center gap-6">
            {property.instagramUrl && (
            <a href={property.instagramUrl} target="_blank" rel="noopener noreferrer" className="p-4 bg-black border-2 border-black shadow-[4px_4px_0px_0px_rgba(255,255,255,0.2)] hover:scale-110 transition-all rounded-full" aria-label="Instagram">
            ...
            {property.tiktokUrl && (
            <a href={property.tiktokUrl} target="_blank" rel="noopener noreferrer" className="p-4 bg-white border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:scale-110 transition-all rounded-full flex items-center justify-center" aria-label="TikTok">
        ...
        <section className="flex flex-col gap-4">
          ...
          {property.ticketsUrl && (
          <a href={property.ticketsUrl} target="_blank" rel="noopener noreferrer" className="w-full py-5 px-8 bg-black border-4 border-black flex items-center justify-between font-medium text-white shadow-[6px_6px_0px_0px_rgba(0,0,0,0.4)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all uppercase tracking-tight text-lg">
            <span>Online Tickets</span>
            <span className="text-xl">🎟️</span>
          </a>
          )}
          {property.whatsappDisabled && (
          <div className="w-full py-5 px-8 bg-green-400 border-4 border-black flex items-center justify-between font-medium text-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] uppercase tracking-tight text-lg opacity-80 cursor-default">
            <span>Join the WhatsApp Group</span>
            <span className="text-sm normal-case tracking-normal font-bold">Coming Soon</span>
          </div>
          )}
          {property.whatsappUrl && (
          <a href={property.whatsappUrl} className="w-full py-5 px-8 bg-green-400 border-4 border-black flex items-center justify-between font-medium text-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all uppercase tracking-tight text-lg">
            <span>Join the WhatsApp Group</span>
          ...
          <a href="https://madmonkeyhostels.com/esim" className="w-full py-5 px-8 bg-blue-500 border-4 border-black flex items-center justify-between font-medium text-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all uppercase tracking-tight text-lg">
            <span>Mad Monkey eSIM</span>
            <span className="text-xl">📱</span>
          </a>
          {(property.id === 'chiang-mai' || property.id === 'uluwatu') && (
            <a href={property.id === 'chiang-mai' ? 'https://krapmaps.app/redeem-chiangmai.html' : 'https://krapmaps.app/redeem-uluwatu.html'} className="w-full py-5 px-8 bg-green-600 border-4 border-black flex items-center justify-between font-medium text-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all uppercase tracking-tight text-lg">
              <div className="flex flex-col">
                <span>KrapMaps</span>
                <span className="text-xs normal-case tracking-normal opacity-90">Map Bins & Earn Rewards. Unlock 1 Month Free Premium!</span>
              </div>
        ...
        <footer className="mt-12 mb-8 flex flex-col items-center gap-8">
          ...
          <div className="flex gap-14">
            <a href={property.instagramUrl ?? 'https://instagram.com/madmonkeyhostels'} className="hover:scale-125 transition-all filter drop-shadow-md" aria-label="Instagram">
            ...
            <a href={property.tiktokUrl ?? 'https://tiktok.com/@madmonkeyhostels'} className="hover:scale-125 transition-all filter drop-shadow-md" aria-label="TikTok">
